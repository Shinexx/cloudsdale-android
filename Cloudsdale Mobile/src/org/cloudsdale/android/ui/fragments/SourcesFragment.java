...
public class SourcesFragment extends SherlockFragment {

	public static final String	TAG	= "Cloudsdale SourceList Fragment";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			currentTab = savedInstanceState.getString("tab");
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View layout = inflater.inflate(R.layout.sources_fragment, container,
				false);
		mTabHost = (TabHost) layout.findViewById(android.R.id.tabhost);
		mTabHost.setup();

		mViewPager = (ViewPager) layout.findViewById(R.id.sources_pager);
		mTabsAdapter = new TabsAdapter(getActivity(), mTabHost, mViewPager);

		// Add the fragment tabs
		...
		mTabsAdapter.addTab(
				mTabHost.newTabSpec("subscriptions").setIndicator(
						"Subscriptions"), SubscriptonsListFragment.class, null);
